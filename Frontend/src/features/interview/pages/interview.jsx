...
const Interview = () => {
  ...
  const renderQuestions = (questions, type) => {
    return questions.map((question, index) => {
      ...
      return (
        <div
          className={`question-card ${isOpen ? "question-open" : ""}`}
          key={key}
        >
          <button
            type="button"
      ...
      <div className="interview-layout">
        ...
        <section className="interview-main">
          ...
          {activeSection === "technical" && (
            <div className="content-section">
              ...
              <div className="questions-list">
                {renderQuestions(technicalQuestions, "technical")}
              </div>
            </div>
          )}
          ...
          {activeSection === "behavioral" && (
            <div className="content-section">
              ...
              <div className="questions-list">
                {renderQuestions(behavioralQuestions, "behavioral")}
              </div>
            </div>
          )}
          ...
          {activeSection === "roadmap" && (
            <div className="content-section roadmap-section">
              <div className="content-heading">
                <div className="heading-row">
              ...
              <div className="roadmap">
                {preparationPlan.map((item) => (
                  <div className="roadmap-item" key={item.day}>
        ...
        <aside className="report-sidebar">
          ...
          <div className="score-section">
            <p className="score-heading">MATCH SCORE</p>
          ...
          <div className="skills-section">
            <p className="skills-heading">SKILL GAPS</p>

            <div className="skills-list">
              {skillGaps.map((gap, index) => (
                <div key={index} className={`skill-gap ${gap.severity}`}>
                  {gap.skill}
                </div>
              ))}
            </div>
          ...
          <div className="mini-roadmap">
            <p className="skills-heading">PREPARATION</p>

            <div className="mini-roadmap-list">
              {preparationPlan.map((item) => (
                <div className="mini-roadmap-item" key={item.day}>
